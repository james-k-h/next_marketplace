      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            <p className="text-sm font-med text-gray-600 font-bold">
            ...
            {order._ispaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Order successfully processed. Please download your media assets!
                Your receipt and order details were sent to:
                <br />
              ...
              <p className="mt-2 text-base text-muted-foreground">
                Your order is currently being processed; confirmation will be
                sent soon.
              </p>
            )}
