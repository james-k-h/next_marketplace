...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: 'Quality validated by our team of experts.',
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
    description:
      "We've pledged 1$ of sales to the preservation of the environment.",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to ____. All assets are verified for compliance and quality
